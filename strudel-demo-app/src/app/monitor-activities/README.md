...
```
strudel add-taskflow my-monitor-activities-tf --template monitor-activities
```
...
### [How to Configure this Task Flow](https://github.com/strudel-science/strudel-kit/blob/main/docs/task-flows/monitor-activities/config.md)
