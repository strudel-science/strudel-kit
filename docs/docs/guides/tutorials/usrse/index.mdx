...
### 1. Change the `palette.primary` colors
...
### 2. Change `palette.mode` to dark

```js
mode: 'dark',
```

### 3. Change the `palette.background` colors
...
### 4. Change the primary font in `typography.fontFamily`
