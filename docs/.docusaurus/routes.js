...
export default [
  ...
  },
  {
    ...
    routes: [
      {
        path: '/',
        component: ComponentCreator('/', '7d3'),
        routes: [
          {
            path: '/',
            component: ComponentCreator('/', '020'),
            routes: [
              {
                path: '/cli/overview',
                component: ComponentCreator('/cli/overview', '8fe'),
                exact: true
              },
              {
                path: '/cli/reference',
                component: ComponentCreator('/cli/reference', 'fff'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
                path: '/components/LabelValueTable',
                component: ComponentCreator('/components/LabelValueTable', 'bdb'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
                path: '/components/LinearMeter',
                component: ComponentCreator('/components/LinearMeter', '81a'),
                exact: true,
                sidebar: "mainSidebar"
              },
              {
